...
public:
  ...
  explicit VarValue(PapyrusVM::Promise<VarValue> promise);
  ...
  std::shared_ptr<PapyrusVM::Promise<VarValue>> promise;
...
private:
  ...
  std::map<uint64_t, std::shared_ptr<PapyrusVM::Promise<VarValue>>> promises;
